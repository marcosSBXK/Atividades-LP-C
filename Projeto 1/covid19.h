...
/* Função que devolve o número total de contágios em um
   país. O 1º argumento da função é o número de dias, o 2º
...
/* Função que devolve o dia de maior contágios e o número
   de contágios em um país. O 1º argumento da função é o 
   número de dias, o 2º argumento é a matriz de contágios,  
   o 3º argumento é o índice na matriz de contágios que 
   representa o país cujo dia de maior contágio e o número de  
...
/* Função que devolve o dia de maior contágios e o número  
   de contágios em todos os países. O 1º argumento da função 
...
/* Função que devolve o tamanho da maior sequência crescente
   de contágios em um país. O 1º argumento da função é o número
